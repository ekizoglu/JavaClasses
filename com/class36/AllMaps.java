...
public class AllMaps {
	public static void main(String[] args) {
		// HashMap store key and value not maintain order
		// Allowed to have 1 null key and many null values
		...
		// Linked hash map store keys and values maintains insertion order
		// Allowed to have 1 null key and many null values
		...
		// treemap store keys and values, maintain ascending order
...
//		treeMap.put(null, "Saturday");
		...
		// Hashtable stores keys and objects does not maintain orders
		// Does not allow to have null keys or null values
		// Synchronized (thread-safe): will prevent simultaneous execution
